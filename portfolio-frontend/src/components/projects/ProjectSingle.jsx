...
const ProjectSingle = ({ isRu, description, description_eng, title,
                         title_eng, stack, image }) => {
  return <>
    <article className="project-single">
      <div className="project-single__picture">
        ...
        <ul className="project-single__stack">
          {
            stack.map(item => {
              return <li key={item.id} className="project-single__stack-item">{item.stackTitle}</li>
            })
          }
        </ul>
      </div>
